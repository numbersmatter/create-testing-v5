...
const navigation = [
  { name: 'Home', urlSegment: '/test-requests', },
  { name: 'Questions', urlSegment: '/questions', },
  { name: 'Forms', urlSegment: '/test-requests/forms', },
  
];
const secondaryNavigation = [
  { name: 'Settings', urlSegment: '/',  },
  { name: 'Help', urlSegment: '/',  },
  { name: 'Privacy', urlSegment: '/', },
];
...
function MobileMenu(props: IMobileMenu) {
  const {sidebarOpen, setSidebarOpen, navigation, secondaryNavigation} = props;
              ...
              >
                <div className="space-y-1 px-2">
                  {navigation.map((item) => (
                    ...
                    >
                      <FolderIcon className="mr-4 h-6 w-6 flex-shrink-0 text-cyan-200" aria-hidden="true" />
                      {item.name}
                    </NavLink>
                  ))}
                </div>
                <div className="mt-6 pt-6">
                  <div className="space-y-1 px-2">
                    {secondaryNavigation.map((item) => (
                      ...
                      >
                        <FolderIcon className="mr-4 h-6 w-6 text-cyan-200" aria-hidden="true" />
                        {item.name}
                      </Link>
                    ))}
                  </div>
...
function DesktopSidebar(props: IDesktopSidebar){
      ...
      <div>
        <Menu.Button className="flex max-w-xs items-center rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 lg:rounded-md lg:p-2 lg:hover:bg-gray-50">
          ...
          <span className="ml-3 hidden text-sm font-medium text-gray-700 lg:block">
            <span className="sr-only">Open user menu for </span>Logout
          </span>
          <ChevronDownIcon
